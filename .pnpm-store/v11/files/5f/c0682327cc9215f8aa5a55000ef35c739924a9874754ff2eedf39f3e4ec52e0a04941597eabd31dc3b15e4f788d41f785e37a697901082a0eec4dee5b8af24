...
let I18nMiddleware = class I18nMiddleware {
    ...
    async use(req, res, next) {
        ...
        language = await (0, utils_1.resolveLanguage)(this.i18nResolvers, new MiddlewareHttpContext(req, res, next), this.moduleRef);
        req.i18nLang =
            (0, utils_1.getLanguageFromResolverResult)(language) || this.i18nOptions.fallbackLanguage;
        if (res?.locals) {
            res.locals.i18nLang = req.i18nLang;
        }
        req.i18nContext = new i18n_context_1.I18nContext(req.i18nLang, this.i18nService, this.messageFormat);
