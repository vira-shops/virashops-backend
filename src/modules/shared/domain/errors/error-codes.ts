enum ErrorCode {
  ...
  PRODUCT_QUESTION_NOT_FOUND = 'PRODUCT_QUESTION_NOT_FOUND',
  INVALID_PRODUCT_RATING = 'INVALID_PRODUCT_RATING',
  INVALID_ORDER_STATUS_TRANSITION = 'INVALID_ORDER_STATUS_TRANSITION',
  SELLER_WAREHOUSE_NOT_FOUND = 'SELLER_WAREHOUSE_NOT_FOUND',
}
